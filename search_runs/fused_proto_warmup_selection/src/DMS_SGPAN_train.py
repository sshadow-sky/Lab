...
def _train_one_round(
    ...
    for epoch in range(args.epochs):
        ...
        if epoch_number == warmup_epochs:
            ...
            try:
                ...
                _write_warmup_metrics(output_dir, args.dataset, "DMS_SGPAN", warmup_metrics, epoch_number)
    ...
    _write_final_metrics(output_dir, args.dataset, "DMS_SGPAN", test_metric, selected_epoch)
