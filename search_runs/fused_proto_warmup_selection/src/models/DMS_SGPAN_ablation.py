...
class DMS_SGPAN_FusedPrototypeAdaptation(_FixedDMS_SGPANAblation):
    ablation_variant = "fused_proto"
...
DMS_SGPAN_ABLATION_MODELS: Dict[str, Type[DMS_SGPAN]] = {
    ...
    "fused_proto": DMS_SGPAN_FusedPrototypeAdaptation,
}
...
__all__ = [
    ...
    "DMS_SGPAN_FusedPrototypeAdaptation",
