...
def train(model, dataset_train, dataset_val, dataset_test, edge_adj, device, output_dir, metrics=None, metric_choose=None, optimizer=None, scheduler=None, batch_size=16, epochs=40, criterion=None, loss_func=None, loss_param=None,test_sub_label=None):
    if metrics is None:
        metrics = ['acc']
