...
def train(model, dataset_train, dataset_val, dataset_test, device, output_dir="result/", metrics=None, metric_choose=None, batch_size=16, epochs=40, test_sub_label=None):
    if metrics is None:
        metrics = ['acc']
