...
def get_args_parser():
    ...
    parser.add_argument('-dms_sgpan_gcl_importance_protect', default=None, action='store_true')
    parser.add_argument('-dms_sgpan_no_gcl_importance_protect', dest='dms_sgpan_gcl_importance_protect', action='store_false')
    parser.add_argument('-dms_sgpan_gcl_importance_centrality_weight', default=None, type=float)
    parser.add_argument('-dms_sgpan_gcl_importance_feature_weight', default=None, type=float)
    parser.add_argument('-dms_sgpan_gcl_node_sample_temperature', default=None, type=float)
    parser.add_argument('-dms_sgpan_gcl_node_sample_eps', default=None, type=float)
    parser.add_argument('-dms_sgpan_gcl_edge_protect_strength', default=None, type=float)
    parser.add_argument('-dms_sgpan_gcl_edge_min_drop_scale', default=None, type=float)
