...
def get_args_parser():
    ...
    # FDGCL optional overrides, mainly used by search_para.py.
    parser.add_argument('-fdgcl_ugfcda_warmup_epochs', default=None, type=int)
    parser.add_argument('-fdgcl_ugfcda_eps', default=None, type=float)
    parser.add_argument('-fdgcl_ugfcda_keep_ratio_start', default=None, type=float)
    parser.add_argument('-fdgcl_ugfcda_keep_ratio_end', default=None, type=float)
    parser.add_argument('-fdgcl_ugfcda_keep_ratio_step', default=None, type=float)
    parser.add_argument('-fdgcl_ugfcda_keep_ratio_step_epochs', default=None, type=int)
    parser.add_argument('-fdgcl_ugfcda_subject_weight', default=None, type=float)
    parser.add_argument('-fdgcl_ugfcda_proto_align_weight', default=None, type=float)
    parser.add_argument('-fdgcl_node_drop_rate', default=None, type=float)
    parser.add_argument('-fdgcl_edge_drop_rate', default=None, type=float)
    parser.add_argument('-fdgcl_gcl_importance_protect', default=None, action='store_true')
    parser.add_argument('-fdgcl_no_gcl_importance_protect', dest='fdgcl_gcl_importance_protect', action='store_false')
    parser.add_argument('-fdgcl_gcl_importance_centrality_weight', default=None, type=float)
    parser.add_argument('-fdgcl_gcl_importance_feature_weight', default=None, type=float)
    parser.add_argument('-fdgcl_gcl_node_sample_temperature', default=None, type=float)
    parser.add_argument('-fdgcl_gcl_node_sample_eps', default=None, type=float)
    parser.add_argument('-fdgcl_gcl_edge_protect_strength', default=None, type=float)
    parser.add_argument('-fdgcl_gcl_edge_min_drop_scale', default=None, type=float)
    parser.add_argument('-fdgcl_dropout', default=None, type=float)
    parser.add_argument('-fdgcl_temperature', default=None, type=float)
    parser.add_argument('-fdgcl_graph_hidden', default=None, type=int)
    parser.add_argument('-fdgcl_graph_readout_hidden', default=None, type=int)
    parser.add_argument('-fdgcl_gcl_readout_hidden', default=None, type=int)
    parser.add_argument('-fdgcl_spectral_hidden', default=None, type=int)
    parser.add_argument('-fdgcl_disentangle_dim', default=None, type=int)
    parser.add_argument('-fdgcl_projection_dim', default=None, type=int)
    parser.add_argument('-fdgcl_cross_scale_heads', default=None, type=int)
    parser.add_argument('-fdgcl_gl_alpha', default=None, type=float)
    parser.add_argument('-fdgcl_cheb_k', default=None, type=int)
    parser.add_argument('-fdgcl_ssbn_eps', default=None, type=float)
    parser.add_argument('-fdgcl_sin_min_count', default=None, type=int)
    parser.add_argument('-fdgcl_grl_max_iters', default=None, type=float)
    parser.add_argument('-fdgcl_loss_ce', default=None, type=float)
    parser.add_argument('-fdgcl_loss_aj', default=None, type=float)
    parser.add_argument('-fdgcl_loss_gcl', default=None, type=float)
    parser.add_argument('-fdgcl_loss_align', default=None, type=float)
    parser.add_argument('-fdgcl_loss_orth', default=None, type=float)
    parser.add_argument('-fdgcl_loss_subject', default=None, type=float)
    return parser
